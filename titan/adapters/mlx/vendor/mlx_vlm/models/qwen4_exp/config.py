...
from ..qwen3_vl_config import VisionConfig as Qwen3VLVisionConfig
from ..qwen3_vl_config import _config_kwargs, _maybe_deserialize_config
...
class TextConfig(BaseModelConfig):
    ...
    # Titan additions.  These are not HF config keys; Titan's loader fills them
    # in so the model module holds no process-global runtime state.
    titan_model_path: Optional[str] = None
    titan_mtp_enabled: bool = False
    titan_mtp_checkpoint_prefix: Optional[str] = None
    titan_mtp_depth: int = 1
